		...
		<div class="popup">
			...
			<div class="product-img-gallery">
				<div class="main-image">
					<img src="<?php echo $theme_url; ?>image/product-4-square.jpg" alt="main-image">
				</div>
				<div class="img-list">
					<img class="image" src="<?php echo $theme_url; ?>image/product-4-square.jpg" alt="image-thumbnail">
					<img class="image" src="<?php echo $theme_url; ?>image/product-5-square.jpg" alt="image-thumbnail">
					<img class="image" src="<?php echo $theme_url; ?>image/product-6-square.jpg" alt="image-thumbnail">
				</div>
			</div>
	...
	<section class="product-list">
		<div class="row item-left">
			<div class="col-sm-6 image">
				<img src="<?php echo $theme_url; ?>image/product-4-square.jpg" alt="product-image">
			</div>
			<div class="col-sm-6">
				<div class="content">
		...
		<div class="row item-right">
			...
			<div class="col-sm-6 image">
				<img src="<?php echo $theme_url; ?>image/product-5-square.jpg" alt="product-image">
			</div>
		</div>

		<div class="row item-left">
			<div class="col-sm-6 image">
				<img src="<?php echo $theme_url; ?>image/product-6-square.jpg" alt="product-image">
			</div>
			<div class="col-sm-6">
				<div class="content">
					<h2 class="title">VIÊN NANG PHÓNG THÍCH CHẬM</h2>
